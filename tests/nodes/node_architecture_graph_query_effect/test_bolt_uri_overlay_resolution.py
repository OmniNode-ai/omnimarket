...
OMN-13557 — the architecture-graph-query config model no longer reads
...
class TestBoltUriOverlayResolution:
    ...
    def test_overlay_resolves_same_value_as_env_read(
        ...
        config = ModelArchitectureGraphQueryConfig()
    ...
    def test_explicit_value_overrides_overlay(
        ...
        config = ModelArchitectureGraphQueryConfig(bolt_uri="bolt://explicit:7687")
