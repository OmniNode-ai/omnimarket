...
class TestDelegationChainE2E:
    ...
    def _run_chain_to_gate_result(
        ...
        # Hop 2: routing reducer consumes the intent, returns the decision;
        # runtime auto-publishes it to routing-decision.v1.
        ...
        # Hop 4: LLM call effect consumes the intent, returns the response;
        # runtime auto-publishes it to inference-response.v1.
        ...
        # Hop 6: quality gate reducer consumes the intent, returns the result;
        # runtime auto-publishes it to quality-gate-result.v1.
