...
def test_retained_live_census_gap_fails_closed() -> None:
    ...
    # drift, runtime health dimensions and lab-pass verdicts = 66. Unlike the
    ...
    # verdicts = 75. The ownership declaration landed one PR earlier, in
    ...
    # database.
    # 20 as of OMN-18769: lab_lane_health is one more source-created table, so
    # the same max(0, 86 - source_created_tables) arithmetic drops the bound by
    # one again, from the 21 the entry above left it at. Same caveat as every
