...
class TestGoldenChainOnboarding:
    ...
    async def test_dry_run_standalone_quickstart(self) -> None:
    ...
    async def test_dry_run_new_employee(self) -> None:
    ...
    async def test_explicit_capabilities_bypass_policy(self) -> None:
    ...
    async def test_dry_run_returns_rendered_output(self) -> None:
    ...
    async def test_skip_steps_reduces_step_count(self) -> None:
        ...
        full_result = await handler.handle(cmd_full)
        skipped_result = await handler.handle(cmd_skipped)
