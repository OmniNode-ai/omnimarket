...
def test_market_node_runtime_dogfood_inventory_classifies_all_entry_points() -> None:
    ...
    # those files into a declared target and the artifact store): 419 -> 421.
    assert summary["node_dirs"] == 421
    ...
    # effect entry points (see the node_dirs comment above): 410 -> 412.
    assert summary["entry_points"] == 412
