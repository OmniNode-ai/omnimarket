...
"""Contract-declared state-coverage regression tests for node_skill_functional_audit_compute.
...
def test_skill_functional_audit_compute_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.skill-functional-audit-completed.v1" in publish_topics
