...
"""Contract-declared state-coverage regression tests for node_feature_dashboard_compute.
...
_CONTRACT_PATH = (
    ...
    / "omnimarket"
    / "nodes"
    / "node_feature_dashboard_compute"
    / "contract.yaml"
)
...
def test_feature_dashboard_compute_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.feature-dashboard-completed.v1" in publish_topics
