...
"""Contract-declared state-coverage regression tests for node_verify_effect.
...
def test_verify_effect_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.build-loop-verify-completed.v1" in publish_topics
