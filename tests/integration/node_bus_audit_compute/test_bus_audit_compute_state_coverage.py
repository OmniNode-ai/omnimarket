...
"""Contract-declared state-coverage regression tests for node_bus_audit_compute.
...
def test_bus_audit_compute_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.bus-audit-completed.v1" in publish_topics


def test_bus_audit_compute_declares_output_fields() -> None:
