...
"""Contract-declared state-coverage regression tests for node_dirty_canonical_sweep.
...
def test_dirty_canonical_sweep_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.dirty-canonical-sweep-completed.v1" in publish_topics
    assert "onex.evt.omnimarket.dirty-canonical-sweep-failed.v1" in publish_topics
