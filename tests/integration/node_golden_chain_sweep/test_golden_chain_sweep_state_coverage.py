...
"""Contract-declared state-coverage regression tests for node_golden_chain_sweep.
...
def test_golden_chain_sweep_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.golden-chain-sweep-result.v1" in publish_topics


def test_golden_chain_sweep_declares_output_fields() -> None:
