...
"""Contract-declared state-coverage regression tests for node_environment_health_scanner.
...
_CONTRACT_PATH = (
    ...
    / "omnimarket"
    / "nodes"
    / "node_environment_health_scanner"
    / "contract.yaml"
)
...
def test_environment_health_scanner_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.environment-health-scan-finding.v1" in publish_topics
