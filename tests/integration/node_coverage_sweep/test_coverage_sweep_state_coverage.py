...
"""Contract-declared state-coverage regression tests for node_coverage_sweep.
...
def test_coverage_sweep_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.coverage-sweep-gap.v1" in publish_topics
