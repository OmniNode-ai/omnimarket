...
"""Contract-declared state-coverage regression test for node_adr_decision_extraction_llm_effect.
...
def test_adr_decision_extraction_llm_effect_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.adr-decision-extraction-completed.v1" in publish_topics
