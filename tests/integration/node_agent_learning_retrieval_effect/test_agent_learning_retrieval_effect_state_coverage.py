...
"""Contract-declared state-coverage regression tests for node_agent_learning_retrieval_effect.
...
def test_agent_learning_retrieval_effect_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimemory.agent-learning-retrieval-response.v1" in publish_topics
