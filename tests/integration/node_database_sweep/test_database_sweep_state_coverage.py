...
"""Contract-declared state-coverage regression tests for node_database_sweep.
...
def test_database_sweep_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.database-sweep-table-checked.v1" in publish_topics


def test_database_sweep_declares_output_fields() -> None:
