...
"""Contract-declared state-coverage regression test for node_thread_reply_effect.
...
def test_thread_reply_effect_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.pr-thread-replied.v1" in publish_topics
