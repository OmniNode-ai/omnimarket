...
"""Contract-declared state-coverage regression test for node_adr_extraction_grader_llm_effect.
...
def test_adr_extraction_grader_llm_effect_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.adr-extraction-grading-completed.v1" in publish_topics
