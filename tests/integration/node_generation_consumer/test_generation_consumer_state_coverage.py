...
"""Contract-declared state-coverage regression test for node_generation_consumer.
...
def test_generation_consumer_declares_output_topics() -> None:
    ...
    assert "onex.cmd.omnimarket.tool-reuse-match-requested.v1" in publish_topics
