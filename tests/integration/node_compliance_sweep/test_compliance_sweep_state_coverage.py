...
"""Contract-declared state-coverage regression tests for node_compliance_sweep.
...
def test_compliance_sweep_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.compliance-sweep-violation.v1" in publish_topics


def test_compliance_sweep_declares_output_fields() -> None:
