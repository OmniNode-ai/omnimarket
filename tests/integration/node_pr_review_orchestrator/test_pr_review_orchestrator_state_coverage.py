...
"""Contract-declared state-coverage regression tests for node_pr_review_orchestrator.

OMN-13674 / OMN-13678 (WS-5 Wave 4) under the strengthened full
...
def test_pr_review_orchestrator_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.pr-review-bot-phase-transition.v1" in publish_topics
    assert "onex.evt.omnimarket.pr-review-bot-thread-posted.v1" in publish_topics
    assert "onex.evt.omnimarket.pr-review-bot-thread-verified.v1" in publish_topics
