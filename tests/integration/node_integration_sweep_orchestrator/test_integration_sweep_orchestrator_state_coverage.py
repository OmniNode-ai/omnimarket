...
"""Contract-declared state-coverage regression tests for node_integration_sweep_orchestrator.
...
def test_integration_sweep_orchestrator_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.integration-sweep-failed.v1" in publish_topics
