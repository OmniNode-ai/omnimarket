...
"""Contract-declared state-coverage regression tests for node_shim_scanner.
...
def test_shim_scanner_declares_output_topics() -> None:
    ...
    assert "onex.evt.omnimarket.shim-scan-completed.v1" in publish_topics
