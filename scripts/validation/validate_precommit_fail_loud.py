...
(OMN-14666, WS7 fan-out of the OMN-14655 canary; ported byte-for-byte from
omniclaude#1904 so both surfaces enforce the identical rule).
...
own docstring when a hook `entry:` resolves this file directly (omnimarket
