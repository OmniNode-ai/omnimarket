...
_TASK_DESCRIPTIONS: dict[str, str] = {
    ...
    "todo-fixme-marker": (
        ...
        "boundary on both sides), e.g. '# TODO: wire this', '# FIXME(jonah) impl', "
        "or 'x = y  # HACK bypass'. The token must be a standalone word: a substring "
        "inside a larger identifier such as TODOLIST, or the letters 'hack' inside "
        "'hackathon', or the lowercase prose phrase 'to do', must NOT be flagged. "
