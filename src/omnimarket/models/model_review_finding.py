...
Owner module (OMN-13208 / A1 re-home): shared across review nodes
(node_hostile_reviewer, node_pr_review_bot). Promote to ``omnibase_core`` only
if a second repo imports these.
"""
