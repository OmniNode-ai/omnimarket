...
"""Prompt Builder — pure COMPUTE primitive for review workflows.

OWNER module (OMN-13208 / A1 re-home), relocated from
``node_hostile_reviewer.handlers.handler_prompt_builder`` into the shared
``omnimarket.review`` package so review nodes share it without cross-node
reach-in.
