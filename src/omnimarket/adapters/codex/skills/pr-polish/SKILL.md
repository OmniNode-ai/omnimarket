...
- **Contract command name:** `pr_polish`
- **Contract command topic:** `onex.cmd.omnimarket.pr-polish-start.v1`
- **Contract terminal topic:** `onex.evt.omnimarket.pr-polish-completed.v1`
...
- Command name: `pr_polish`
- Target contract command topic: `onex.cmd.omnimarket.pr-polish-start.v1`
- Target contract terminal topic: `onex.evt.omnimarket.pr-polish-completed.v1`
