"""Env-parity models shared by node_env_parity_compute (pure snapshot primitive)
and node_env_parity_collect_effect (live lane collection front-end).

Moved from node_env_parity_compute.models in OMN-13925 so the collect effect
does not import another node's private model package.
"""
