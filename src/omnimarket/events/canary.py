...
"""Shared canary event models — canonical home for cross-node canary contracts.

These models are consumed by node_adr_canary_orchestrator (producer) and
node_canary_score_reducer (consumer). Keeping them here avoids cross-node
model reach-in violations (OMN-9263).
"""
