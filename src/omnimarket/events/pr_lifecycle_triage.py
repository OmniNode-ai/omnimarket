...
"""Shared PR lifecycle triage event models."""
...
class ModelPrTriageInput(BaseModel):
    """Input to the PR triage compute node from inventory data."""
...
__all__: list[str] = ["ModelPrInventoryItem", "ModelPrTriageInput"]
