...
from omnimarket.nodes.node_loop_state_reducer.models.enum_build_loop_intent_type import EnumBuildLoopIntentType
...
class HandlerLoopState:
    ...
    def delta(
        ...
        # Handle skip_closeout: IDLE -> VERIFYING directly (skip CLOSING_OUT)
