...
"""Task-level contract models for dispatch verification.

EnumDodCheckType is a closed enum — each value maps to a hardcoded function
in dod_verification_registry.py. No arbitrary commands from ticket text. (C6 fix)
"""
...
class ModelDodEvidenceCheck(BaseModel, frozen=True):
