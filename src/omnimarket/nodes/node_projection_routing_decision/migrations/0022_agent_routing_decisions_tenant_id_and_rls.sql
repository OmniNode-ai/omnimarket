-- OMN-15655 / operator ruling 2026-08-02 (house tenant): give agent_routing_decisions a
-- tenant identity and row-level tenant isolation.
--
-- a routing decision is made for a specific workload THIS RELATION IS TENANT DATA
...
-- in the same PR; agent_routing_decisions omitted it in error.
GRANT SELECT ON public.agent_routing_decisions TO app_dashboard;
