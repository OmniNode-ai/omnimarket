-- OMN-15655 / operator ruling 2026-08-02 (house tenant): give pattern_learning_artifacts a
-- tenant identity and row-level tenant isolation.
--
-- learned patterns are derived from a tenant's own execution history THIS RELATION IS TENANT DATA
