-- OMN-15655 / operator ruling 2026-08-02 (house tenant): give skill_execution_snapshots a
-- tenant identity and row-level tenant isolation.
--
-- skill-execution snapshots count a tenant's own skill runs THIS RELATION IS TENANT DATA
...
-- Read grant for the live dashboard reader (omnidash SkillAdoptionWidget reads this relation). RLS still filters every
