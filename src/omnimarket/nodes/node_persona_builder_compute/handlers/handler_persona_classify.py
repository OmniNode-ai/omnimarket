...
class HandlerPersonaClassify:
    """ONEX handler class for persona classification.

    Thin class wrapper exposing classify_persona as a handler callable
    for runtime entry-point registration.
    """

    @staticmethod
    def classify(request: ModelPersonaClassifyRequest) -> ModelPersonaClassifyResult:
