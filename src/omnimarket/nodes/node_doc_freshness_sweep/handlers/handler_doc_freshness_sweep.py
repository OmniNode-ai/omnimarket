...
try:
    ...
    EnumDocStalenessVerdict = None  # type: ignore[assignment,misc]
    ModelDocFreshnessSweepReport = None  # type: ignore[assignment,misc]
    ModelRepoDocSummary = None  # type: ignore[assignment,misc]
