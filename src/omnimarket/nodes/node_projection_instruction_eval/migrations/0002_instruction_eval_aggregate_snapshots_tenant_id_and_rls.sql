-- OMN-15655 / operator ruling 2026-08-02 (house tenant): give instruction_eval_aggregate_snapshots a
-- tenant identity and row-level tenant isolation.
--
-- instruction-eval aggregates measure a tenant's own model/task runs THIS RELATION IS TENANT DATA
...
-- Read grant for the live dashboard reader (a live dashboard reader consumes instruction-eval aggregates). RLS still filters every
