...
class NodeAgentLearningRetrievalEffect:
    ...
    __onex_node_type__: str = "node_agent_learning_retrieval_effect"
    ...
    def handler_id(self) -> str:
        return "node_agent_learning_retrieval_effect"
    ...
    async def handle(
        ...
        The contract handler.class points here, but the omnimemory Qdrant
        adapter that performs the actual retrieval has not been wired via DI.
        ...
        raise NotImplementedError(  # stub-ok: OMN-8298 Wave-2 DI wiring pending; loud-fail preferred over silent dispatch
            "node_agent_learning_retrieval_effect.handle() not implemented: "
