...
Reads the model_routing policy schema from contract.yaml and requires callers
to provide logical route keys plus matching runtime route configs. Missing
route inputs fail loudly; this loader does not substitute fallback model IDs.

Related: OMN-7981, OMN-11936
"""
