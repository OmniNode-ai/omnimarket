-- OMN-15655 / operator ruling 2026-08-02 (house tenant): give llm_cost_aggregates a
-- tenant identity and row-level tenant isolation.
--
-- LLM cost aggregates are spend attributable to whoever ran the workload THIS RELATION IS TENANT DATA
...
-- in the same PR; llm_cost_aggregates omitted it in error.
GRANT SELECT ON public.llm_cost_aggregates TO app_dashboard;
