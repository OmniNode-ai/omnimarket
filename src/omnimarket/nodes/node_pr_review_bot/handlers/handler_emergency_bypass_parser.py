...
TOPIC_BYPASS_ROLLED_BACK = "onex.evt.omnimarket.review-bot-bypass-rolled-back.v1"  # onex-topic-allow: contract-declared
TOPIC_BYPASS_USED = "onex.evt.omnimarket.review-bot-bypass-used.v1"  # onex-topic-allow: contract-declared
