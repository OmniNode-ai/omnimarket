...
"""Dispatcher adapter for delegation inference response events."""
...
class DispatcherInferenceResponse(MixinAsyncCircuitBreaker):  # type: ignore[misc]
    ...
    async def handle(
        ...
        try:
            ...
            intents = self._handler.handle_inference_response(payload)
            ...
            logger.info(
                "DispatcherInferenceResponse processed response",
                extra={
